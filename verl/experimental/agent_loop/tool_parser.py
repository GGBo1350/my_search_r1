...
class ToolParser(ABC):
    ...
    def stop_strings(self) -> list[str]:
        """Full text sequences that should stop generation after a tool call.

        Use this for multi-token delimiters. Returning their individual token
        IDs from ``stop_token_ids`` would stop on any component token.
        """
        return []
