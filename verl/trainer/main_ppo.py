...
class TaskRunner:
    ...
    def init_resource_pool_mgr(self, config):
        ...
        if is_distillation_enabled(distillation_config):
            ...
            if not distillation_config.get("colocate_with_actor", False):
    ...
    def add_teacher_model_resource_pool(self, config):
        ...
        if is_distillation_enabled(config.get("distillation")):
            ...
            colocate = config.distillation.get("colocate_with_actor", False)
            self.mapping[Role.TeacherModel] = "global_pool" if colocate else "teacher_pool"
