#!/usr/bin/env bash
# Phase 1: historical continuation experiment from step 100 to step 200.
RUN_ID=$(date +%Y%m%d_%H%M%S)
exec > /root/autodl-tmp/train_logs/qwen3_4b_sglang_16x8_100to200_907_${RUN_ID}.launch.log 2>&1
