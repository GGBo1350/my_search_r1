#!/usr/bin/env bash
# Bridge specialist teacher: all seven Qwen3 LoRA projections, 75 steps.
...
LOG_FILE="${ARTIFACT_ROOT}/train_logs/qwen3_4b_teacher_bridge_full_lora_931_${RUN_ID}.launch.log"
...
export TRAIN_FILE=${TRAIN_FILE:-./data/hotpotqa_v3_hard_1600/train_bridge_1200.parquet}
...
export CHECKPOINT_DIR=${CHECKPOINT_DIR:-"${ARTIFACT_ROOT}/checkpoints/qwen3_4b_teacher_bridge_full_lora_931_${RUN_ID}"}
export ROLLOUT_DATA_DIR=${ROLLOUT_DATA_DIR:-"${ARTIFACT_ROOT}/rollouts/qwen3_4b_teacher_bridge_full_lora_931_${RUN_ID}"}
export PROJECT_NAME=${PROJECT_NAME:-search_r1_teacher_full_lora}
export EXPERIMENT_NAME=${EXPERIMENT_NAME:-qwen3_4b_teacher_bridge_full_lora_931_${RUN_ID}}
